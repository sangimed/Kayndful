...
import { SafeAreaView, View, Text, StyleSheet, KeyboardAvoidingView, Platform, ScrollView, Image } from "react-native";
...
export default function SummaryStep() {
  ...
  const visibilityText = state.identity.visibility === "initial" ? t("summary_visibility_initial") : t("summary_visibility_hidden");
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.select({ ios: "padding", android: undefined })}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.row}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.meta}>@{state.identity.username || t("summary_username_missing")}</Text>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.body}>{t("availability_radius")}: {radiusText}</Text>
            <Text style={styles.body}>{t("availability_mode")}: {modeText}</Text>
          </View>
