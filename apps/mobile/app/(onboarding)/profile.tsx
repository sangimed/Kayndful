...
import { SafeAreaView, View, Text, StyleSheet, KeyboardAvoidingView, Platform, ScrollView, Image, Pressable } from "react-native";
...
export default function ProfileStep() {
  ...
  const onUpload = async () => {
    ...
    try {
      dispatch({ type: "profile/update", payload: { avatarUri: Image.resolveAssetSource(require("../../assets/icon.png")).uri } });
    } catch {
